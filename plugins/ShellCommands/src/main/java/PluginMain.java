...
public class PluginMain extends GenericPluginInterface implements CommandCallback
{
    ...
    public void activate(PublicExposedFunctions out, PluginCallbackRegister register)
    {
        ...
        register.registerCommandPlugin(
                                       ...
                                       "U",
                                       "<command> <parameters>",
                                       "Runs the specified local command without returning any output.  I recommend using this with aliases",
                                       null);
        register.registerCommandPlugin(
                                       this,
                                       "run",
                                       ...
                                       "U",
                                       "<command> <parameters>",
                                       "Runs the specified local command and displays the output.  I don't recommend using this for anything that returns more than a couple lines",
                                       null);
        register.registerCommandPlugin(this, "runstop", 0, false, "U", "<command num>",
                                       "Stops the specified local command from running", null);
    }
