...
public class PluginMain extends GenericPluginInterface implements CommandCallback, EventCallback
{
    ...
    public void activate(PublicExposedFunctions out, PluginCallbackRegister register)
    {
        ...
        register.registerCommandPlugin(
                                       ...
                                       "D",
                                       "[user]",
                                       "Designates the requested user.  If no user is speciied, it designates the person that used the command.",
                                       null);
        register.registerCommandPlugin(
                                       this,
                                       "op",
                                       ...
                                       "D",
                                       "[user]",
                                       "Designates the requested user, then rejoins the channel.  If no user is specified, it designates the user that used the command.",
                                       null);
    ...
    public Properties getSettingsDescription()
    {
        ...
        p.setProperty(
                      "autodesignate flag",
                      "The flag(s) which, when users have it/them, will automatically give the user ops upon entering the channel.");
        return p;
    }
            ...
            Object data) throws PluginException, IOException, CommandUsedIllegallyException, CommandUsedImproperlyException
    {
        ...
        else
        {
            out.sendTextUser(
                             user,
                             "There was an error in designate plugin -- command not found.  Please report to iago.",
                             loudness);
        }
    }
