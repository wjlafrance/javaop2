...
public class PluginMain extends GenericPluginInterface implements CommandCallback
{
    ...
    public void activate(PublicExposedFunctions out, PluginCallbackRegister register)
    {
        ...
        register.registerCommandPlugin(this, "version", 0, false, "ANL", "<null>", "Displays the current bot version.", null);
    ...
    {
        if (args.length != 0)
            throw new CommandUsedImproperly("The version command requires no parameters.", user, command);
        ...
        if (command.equalsIgnoreCase("version"))
        {
            ...
            out.sendTextUserPriority(user, "JavaOp2 " + staticFuncs.getVersion() + " (" + "javaop.com" + ")" + " [" + osName + " " + osVersion + " (" + osArch + ")]", loudness, PRIORITY_LOW);
