...
//            desktop.setFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS, newForwardKeys);
    ...
    public void minimizeAll()
    {
        ...
        for(int i = 0; i < frames.length; i++)
            try { frames[i].setIcon(true); } catch(PropertyVetoException e) { };
    }
    ...
    public void maximizeAll()
    {
        ...
        for(int i = 0; i < frames.length; i++)
        {
            try { frames[i].setIcon(false); } catch(PropertyVetoException e) { };
            try { frames[i].setMaximum(true); } catch(PropertyVetoException e) { };
        }
    }
