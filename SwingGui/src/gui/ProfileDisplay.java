...
public class ProfileDisplay extends JFrame implements WindowListener
{
    ...
    public ProfileDisplay(PublicExposedFunctions out, String name, String sex, String age, String location, String description)
    {
        ...
        ValuePanel descriptionPanel = new ValuePanel("Description", new JScrollPane(descriptionField), BorderLayout.NORTH);
    ...
    public void windowClosing(WindowEvent e)
    {
        ...
        if(((String) out.getLocalVariable("username")).equalsIgnoreCase(name))
        {
            ...
            if(sex.equals(sexField.getText()) == false || age.equals(ageField.getText()) == false || location.equals(locationField.getText()) == false || description.equals(descriptionField.getText()) == false)
            {
                if(JOptionPane.showConfirmDialog(this, "Save new profile?", "Save?", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)
                {
