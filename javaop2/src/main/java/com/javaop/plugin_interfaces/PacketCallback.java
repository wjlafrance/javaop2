...
public interface PacketCallback extends AbstractCallback
{
	 ...
	 */
	BnetPacket processingPacket(BnetPacket buf, Object data) throws IOException, PluginException;

	/**
	 * This is called when a packet has completed being send , and it can no
	 * longer be modified/dropped.
	 */
	void processedPacket(BnetPacket buf, Object data) throws IOException, PluginException;
}
