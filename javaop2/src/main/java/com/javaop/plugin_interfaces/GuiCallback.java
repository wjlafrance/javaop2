...
public interface GuiCallback extends AbstractCallback
{
	 ...
	 */
	void menuItemAdded(String name, String whichMenu, int index, char mnemonic, KeyStroke hotkey, Icon icon,
	 ...
	 * for the current bot.
	 */
	void menuItemRemoved(String name, String whichMenu, Object data);
	 ...
	 * bad.
	 */
	void menuSeparatorAdded(String whichMenu, Object data);
	 ...
	 */
	void menuAdded(String name, int index, char mnemonic, Icon icon, ActionListener callback, Object data);

	/**
	 * Remove a menu (and, obviously, all the items under it)
	 */
	void menuRemoved(String name, Object data);

	/**
	 * Called when a plugin requests to add a menu item for users (ie,
	 * right-click on a user, and there's the menu)
	 */
	void userMenuAdded(String name, int index, Icon icon, ActionListener callback, Object data);

	/** Called when a plugin requests to remove a men item for users */
	void userMenuRemoved(String name, Object data);

	/** Called when a plugin requests to add a user menu separator */
	void userMenuSeparatorAdded(Object data);
