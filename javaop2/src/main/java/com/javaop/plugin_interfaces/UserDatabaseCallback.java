...
public interface UserDatabaseCallback extends AbstractCallback
{
	...
	void userAdded(String username, String flags, Object data);

	/** A user who was already in the database was given new flags */
	void userChanged(String username, String oldFlags, String newFlags, Object data);

	/** A user who was in the database before was removed */
	void userRemoved(String username, String oldFlags, Object data);
}
