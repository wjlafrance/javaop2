 ...
 * for the key type. The below methods are dummy methods, but serve as an interface for the other classes. As of
 * 09/15/2009 these are:
 * 
 * Num13Decode - Legacy StarCraft keys Alpha16Decode - Legacy Diablo II, current WarCraft II keys Alpha24 Decode - All
 * keyed products except WarCraft II
 * 
 * @author iago, joe
 */
public class Decode
