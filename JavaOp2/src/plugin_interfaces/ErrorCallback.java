...
/** These are error callbacks that are called when an error occurs.  These aren't allowed to throw an exception
 * because that would likely cause infinite recursion.  If any of them DO throw an error or exception, it will
 * be caught and displayed to stdout rather than calling one of these.
 * 
 * @author iago
 *
 */
