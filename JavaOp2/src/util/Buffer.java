...
public class Buffer
{
    ...
    /** Removes and returns a null-terminated byte array, with the null removed. This is to be used
     * for data that contains non ASCII-safe bytes that get corrupted by String.
     * @return An array of bytes, ending at the next null-terminator on the buffer (not including it)
     * @throws IndexOutOfBoundsException If the buffere ended before finding a null
     */
    ...
    /** Adds a null-terminated byte array. This is the same as addNTString, except this accepts bytes
     * and is compatable with bytes that aren't ASCII safe and are corrupted in the String data type.
	 * @param b The array of data to add.
     */
